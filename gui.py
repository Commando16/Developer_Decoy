...
class App2(customtkinter.CTk):
    ...
    def __init__(self):
        ...
        self.system_info_frame.grid(row=0, column=0, columnspan=1, rowspan=3, padx=10, pady=10,sticky="ewn")
        ...
        self.debug_switch = customtkinter.CTkSwitch(
                                ...
                                text="Debug", 
                                command=partial(self.button_callback, f"logging_switch {self.debug_switch_value.get()}"),
